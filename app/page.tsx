          ...
          <section className="h-[340px] md:h-[500px] w-94% rounded-3xl lg:justify-between mb-10 backdrop-blur-lg bg-bg-mygrey/80 items-center flex justify-start flex-row px-10">
            <div className="lg:w-3/4 w-full ">
              <h1 className=" brightness-150 text-white  contrast-150 font-Figtree font-extrabold text-justify md:text-left text-sm sm:text-2xl lg:text-3xl">
                The "NoteCloud" project is an innovative web application
                designed for effective self-management and productivity
                improvement. It is an intelligent system for organizing notes
                and tasks based on cloud technologies.
              </h1>
            </div>
          ...
          <section className="flex justify-between w-94% flex-col lg:flex-row">
            <section className="w-full lg:w-[30%] min-w-[300px] aspect-w-4 aspect-h-4 rounded-3xl p-10 backdrop-blur-lg bg-bg-mygrey/80 items-center flex flex-col justify-center mb-10 lg:mb-0">
              ...
              <p className="text-white font-Figtree font-extrabold text-justify xl:px-5 text-sm sm:text-2xl lg:text-xl">
                ...
                storage for saving and synchronizing their notes and tasks
                across different devices. This ensures data accessibility at any
          ...
          <section className="h-[340px] md:h-[500px] w-94% rounded-3xl backdrop-blur-lg mb-10 bg-bg-mygrey/80 items-center flex justify-end px-10">
            ...
            <div className="lg:w-3/4 w-full ">
              <h1 className="brightness-150 text-white  contrast-150 font-Figtree font-extrabold text-justify md:text-left text-sm sm:text-2xl lg:text-3xl">
                ...
                security and protection of user data. The application is
                developed solely for educational purposes, and the author does
                not guarantee the complete security of user information. Users
                should be aware that using NoteCloud may not provide a high
                level of data security. and it is recommended to avoid using
